...
const About = () => {
  return (
    ...
    initial={{ opacity: 0, x: 200 }}
        ...
        viewport={{ once: true }}
    id="about" className='scroll-mt-32 flex flex-col items-center justify-center container mx-auto px-4 py-14 md:px-20 lg:px-32 overflow-hidden'>
      <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>
        About <span className='underline underline-offset-4 decoration-1 font-light'>Our Brand</span>
      </h1>
      <p className='text-gray-400 max-w-xs sm:max-w-md text-center mb-8'>
      ...
      <div className='flex flex-col md:flex-row items-center md:items-start gap-10'>
        ...
        <div className='flex flex-col items-center md:items-start mt-10 text-gray-600 w-full'>
          <div className='grid grid-cols-2 gap-6 md:gap-10 w-full md:max-w-lg'>
            <div>
